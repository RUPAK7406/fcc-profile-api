...
class fccChallenge2(scrapy.Spider):
    name = "challenge2"
    def __init__(self, username=None, *args, **kwargs):
        super(fccChallenge2, self).__init__(*args, **kwargs)
        # Setup URLs
        self.start_urls = ["http://local.htko.ca/sources/challenge-standard.html"]
